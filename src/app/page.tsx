          ...
          return (
            ...
            >
              ...
              {(() => {
                ...
                const svgPath = `M 30,0 H ${W - 30} A 30,30 0 0 1 ${W},30 A 30,30 0 0 1 ${W - 30},60 H ${W/2 + 94} C ${W/2 + 79},60 ${W/2 + 79},70 ${W/2 + 79},82 A 22,22 0 0 1 ${W/2 + 57},104 H ${W/2 - 57} A 22,22 0 0 1 ${W/2 - 79},82 C ${W/2 - 79},70 ${W/2 - 79},60 ${W/2 - 94},60 H 30 A 30,30 0 0 1 0,30 A 30,30 0 0 1 30,0 Z`;
                ...
                {/* Bottom Row (52px exactly, 158px wide) */}
                <div className="md:hidden flex items-center justify-center h-[52px] w-[158px] relative z-10 pb-2">
                  <button
                    onClick={() => handleNavClick("about")}
